...
- pinned normalization of rsync's safe `02700`, `0755`, or already-correct
  `02755` top-level candidate outcomes to the intended deploy-group-inheriting
  `02755` mode before publication;
